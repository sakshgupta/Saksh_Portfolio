...
export default function Hero({ about, textEnter, textLeave, linkEnter, imgHover, imgHoverLeave }: Props) {
    return (
        <div className='h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden'>
            ...
            <div className='z-20'>
                ...
                <div className='pt-5'>
                    <Link href="#about" onMouseEnter={linkEnter} onMouseLeave={textLeave}>
                        <button className='heroButton'>About</button>
                    </Link>
                    <Link href="#skills" onMouseEnter={linkEnter} onMouseLeave={textLeave}>
                        <button className='heroButton'>Skills & Experience</button>
                    </Link>
                    <Link href="#projects" onMouseEnter={linkEnter} onMouseLeave={textLeave}>
